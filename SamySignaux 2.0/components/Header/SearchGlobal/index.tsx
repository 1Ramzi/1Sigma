    ...
    return (
        <>
            ...
            >
                ...
                />
                <div
                    className={`absolute top-[calc(100%+0.625rem)] left-0 z-100 w-106.5 p-3 rounded-4xl bg-b-surface2 border border-transparent dark:border-s-border shadow-dropdown transition-all max-[1179px]:w-99.5 max-lg:right-0 max-lg:w-auto ${
                        visibleResult
                            ? "visible opacity-100"
                            : "invisible opacity-0"
                    }`}
