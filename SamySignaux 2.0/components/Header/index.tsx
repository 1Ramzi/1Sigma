                ...
                >
                    ...
                    <div className="hidden md:block">
                        <Button 
                            as="link" 
                            href="/broker"
                            className="bg-primary-01 hover:bg-primary-02 text-white px-4 py-2 !h-10 rounded-lg flex items-center gap-2 text-sm font-semibold"
                        >
                            <Icon name="shield" className="w-4 h-4 fill-white" />
                            <span>Broker</span>
                        </Button>
                    </div>
                    <Notifications />
