...
const ShopItem = ({ className, value }: ShopItemProps) => {
    ...
    return (
        <div
            className={`group flex flex-col gap-2 p-2 pb-6 bg-b-surface2 rounded-4xl max-3xl:pb-2 transition-shadow hover:shadow-depth border border-transparent dark:border-s-border ${
                className || ""
            }`}
