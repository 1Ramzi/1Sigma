...
import { TeamMemberData } from "../../Team/TeamMemberData";
import { v4 as uuidv4 } from "uuid";
export default function TeamOne({ dark }) {
	return (
		<div className={`section zuzu-section-padding3 ${dark && "bg-gray-500"}`}>
			<div className="container">
					...
					<div className="row">
						<div className="col-lg-6">
							<div className={`zuzu-default-content large ${dark && "dark"}`}>
								...
								<h2>Meet our founding creative team</h2>
							</div>
						</div>
						<div className="col-lg-6 d-lg-flex justify-content-end align-items-center">
							<Link href={"/team-light"} legacyBehavior>
								<a className="zuzu-btn btn-pink rounded-pill">Meet All Members</a>
							</Link>
						</div>
					</div>
				</div>
				...
				<div className="row">
					{TeamMemberData.slice(0, 3).map((item) => (
						<div key={uuidv4()} className="col-xl-4 col-md-6">
							<div className={`zuzu-team-wrap wow fadeInUpX ${dark && "dark"}`} data-wow-delay="0s">
								<div className="zuzu-team-thumb">
									<img src={`/images/all-img/team/${item.img}.png`} alt="" />
								</div>
								<div className="zuzu-team-data zuzu-v2">
									<h4>{item.name}</h4>
									<p>
										{item.degination}
										<Link href={item.linkedInId}>
											<svg
												width="20"
												height="20"
												viewBox="0 0 20 20"
