...
import { BlogDropdownMenus, DemoDropdownMenus, PagesDropdownMenus } from "../Navbar/menu-data";
import Logo from "./Component/Logo";

export default function HeaderHomeFive({ btnColor }) {
	...
	return (
		<header
			className={`site-header zuzu-header-dark site-header--menu-right zuzu-header-section header-deep-pink ${
				scroll ? "sticky-menu" : ""
			}`}
			id="sticky-menu"
		>
