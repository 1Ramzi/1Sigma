                ...
                <DialogPanel
                    className={`bg-b-surface1 ${
                        isSlidePanel
                            ...
                            : "w-full max-w-143 m-auto p-12 shadow-depth rounded-3xl duration-300 ease-out data-[closed]:scale-95 data-[closed]:opacity-0 max-md:p-6 dark:shadow-none border border-transparent dark:border-s-border"
                    } ${classWrapper || ""}`}
                    transition
                >
                    {children}
