...
const LivePage = () => {
    ...
    const [chatMessages, setChatMessages] = useState([
        { user: 'SamyTrader', text: 'On attend le signal EUR/USD', time: '22:01' },
        ...
        { user: 'SamySignaux', text: 'On surveille BTC/USD et XAU/USD ce soir', time: '22:07' },
    ]);
                                ...
                                {schedule.map((s, i) => (
                                    ...
                                    >
                                        <div className={`text-caption font-bold mb-1.5 ${i === todayIndex ? 'text-primary-01' : 'text-t-primary'}`}>
                                            {s.day}
                                            {i === todayIndex && <span className="ml-1 text-[10px] font-medium text-primary-02">●</span>}
                                        </div>
                                        {s.sessions.length > 0 ? (
                                    ...
                                    <div key={i} className="flex gap-2">
                                        ...
                                        <div className="min-w-0">
                                            <div className="flex items-baseline gap-2">
                                                <span className={`text-[11px] font-bold ${msg.user === 'SamySignaux' ? 'text-primary-01' : msg.user === 'Vous' ? 'text-primary-02' : 'text-t-primary'}`}>{msg.user}</span>
