    ...
    const sections = [
        {
            ...
            content: "En utilisant la plateforme SamySignaux, vous acceptez les présentes conditions. Le service fournit des signaux de trading à titre informatif. Toute décision d'investissement est prise sous votre propre responsabilité.",
        },
        {
            id: 2,
