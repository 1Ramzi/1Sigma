...
const timeOptionsShort: TabsOption[] = [
    { id: 1, name: "1D" },
    { id: 2, name: "7D" },
    { id: 3, name: "1M" },
    { id: 4, name: "6M" },
...
const Overview = ({}) => {
    const [timeShort, setTimeShort] = useState<TabsOption>(timeOptionsShort[4]);
    const [timeLong, setTimeLong] = useState<SelectOption>(timeOptionsLong[4]);
