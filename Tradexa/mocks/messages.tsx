...
export const messages = [
    {
        ...
        avatar: "/images/avatars/2.png",
        content:
            "Got a rough date for when the coded version of Tradexa 2.0 will be out?",
        time: "now",
        new: true,
    },
    {
    ...
    },
    {
        ...
        avatar: "/images/avatars/4.png",
        content:
            "Can you tell us when the coded version of Tradexa 2.0 is launching?",
        time: "1h",
        new: true,
    },
    {
        ...
        content:
            "When can we expect the coded version of Tradexa 2.0?",
        time: "3h",
        new: true,
    },
    {
    ...
    },
    {
        ...
        content:
            "Any updates on the release of the coded version for Tradexa 2.0?",
        time: "10h",
        new: false,
    },
    {
        ...
        content:
            "Any news on when the coded version of Tradexa 2.0 will be available?",
        time: "15h",
        new: false,
    },
    {
        ...
        content: (
            <>
                <p>
                    ...
                    <br></br>
                    <a href="https://tradexa.com/product-link" target="_blank" rel="noreferrer">
                        https://tradexa.com/product-link
                    </a>
                </p>
            </>
        ),
