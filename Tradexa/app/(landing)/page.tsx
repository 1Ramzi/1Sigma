...
const stats = [
    ...
    { value: "78%", label: "Taux de rÃ©ussite moyen" },
    { value: "24/7", label: "Signaux & alertes" },
    { value: "12", label: "MarchÃ©s couverts" },
];

const features = [
    {
        title: "Signaux IA en temps rÃ©el",
        description:
            "Des alertes prÃªtes Ã  exÃ©cuter, construites sur des scÃ©narios multi-timeframes.",
        icon: Sparkles,
    },
    {
        title: "Gestion du risque guidÃ©e",
        description:
            "Chaque signal inclut des zones d'entrÃ©e, invalidation et objectifs progressifs.",
        icon: ShieldCheck,
    },
    {
        title: "CommunautÃ© de performance",
        description:
            "Analyse collective, dÃ©brief quotidien et revue des exÃ©cutions pour progresser vite.",
        icon: Users,
    },
    {
        title: "Tracking transparent",
        description:
            "Historique public des performances et mÃ©triques claires pour chaque stratÃ©gie.",
        icon: TrendingUp,
    },
];
...
const plans = [
    {
        name: "Starter",
        price: "0â‚¬",
        description: "DÃ©couvrir l'Ã©cosystÃ¨me Tradexa",
        bullets: ["Signaux quotidiens limitÃ©s", "AccÃ¨s communautÃ©", "1 dÃ©brief / semaine"],
        cta: "Commencer",
        featured: false,
    },
    {
        ...
        bullets: [
            ...
            "Room privÃ©e & coaching de groupe",
        ],
        cta: "Passer Pro",
        featured: true,
    },
    {
        name: "Mentorat Elite",
        price: "149â‚¬",
        description: "Accompagnement 1:1 et stratÃ©gie personnalisÃ©e",
        bullets: ["Sessions individuelles", "Risk plan sur mesure", "Suivi avancÃ© des performances"],
...
const faqs = [
    {
        q: "Est-ce que Tradexa prend la main sur mon capital ?",
        a: "Non. Vous gardez le contrÃ´le total. Nous envoyons uniquement des plans d'exÃ©cution, sans accÃ¨s Ã  vos fonds.",
    },
    {
        q: "Quels marchÃ©s sont couverts ?",
        a: "Principalement Forex, crypto, indices et mÃ©taux, avec une rotation selon la volatilitÃ© et la liquiditÃ©.",
    },
    {
        q: "Puis-je commencer sans expÃ©rience ?",
        a: "Oui. Le parcours Starter et les dÃ©briefs hebdomadaires sont conÃ§us pour les dÃ©butants motivÃ©s.",
    },
    {
        q: "Comment est calculÃ© le taux de rÃ©ussite ?",
        a: "Il est basÃ© sur l'historique des signaux clÃ´turÃ©s, publiÃ© avec rÃ¨gles d'entrÃ©e/sortie identiques pour tous.",
    },
];
        ...
        <div className="relative min-h-screen overflow-x-hidden bg-b-surface1 text-t-primary">
            ...
            <header className="sticky top-0 z-40 border-b border-s-subtle/80 bg-b-surface1/85 backdrop-blur-xl">
                <div className="mx-auto flex h-20 w-full max-w-6xl items-center justify-between px-6">
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-semibold tracking-tight">Tradexa</span>
                    </Link>
            ...
            <main>
                <section className="mx-auto grid w-full max-w-6xl gap-12 px-6 pb-16 pt-14 lg:grid-cols-2 lg:items-center lg:pt-20">
                    <div>
                        ...
                        <p className="mt-6 max-w-xl text-base text-t-secondary md:text-lg">
                            Tradexa fusionne signaux, exÃ©cution et mentorat dans une mÃªme
                            expÃ©rience. Moins d&apos;hÃ©sitation, plus de discipline, de meilleurs rÃ©sultats.
                        </p>
                ...
                <section id="features" className="mx-auto w-full max-w-6xl px-6 py-16">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <h2 className="mt-3 text-3xl font-semibold md:text-5xl">Architecture pensÃ©e pour les traders sÃ©rieux</h2>
                    </div>
                ...
                <section id="solution" className="mx-auto grid w-full max-w-6xl gap-10 px-6 py-16 lg:grid-cols-2 lg:items-center">
                    ...
                    <div>
                        ...
                        <h2 className="mt-3 text-3xl font-semibold md:text-5xl">Une stack complÃ¨te, de l&apos;idÃ©e Ã  l&apos;exÃ©cution</h2>
                        <p className="mt-4 text-base text-t-secondary">
                            InspirÃ©e de la structure Teaser, cette nouvelle landing se concentre sur la
                            preuve de valeur, la lisibilitÃ© du parcours utilisateur et la conversion.
                        </p>
                        <ul className="mt-6 space-y-3">
                            {[
                                "Pipeline simple : dÃ©couvrir â†’ tester â†’ convertir",
                                "Sections orientÃ©es bÃ©nÃ©fices et confiance",
                                "Design responsive et optimisÃ© pour mobile",
                            ].map((line) => (
                ...
                <section id="faq" className="mx-auto w-full max-w-4xl px-6 py-16">
                    <div className="text-center">
                        ...
                        <h2 className="mt-3 text-3xl font-semibold md:text-5xl">Questions frÃ©quentes</h2>
                    </div>
            ...
            <footer className="mx-auto w-full max-w-6xl px-6 pb-10 pt-6">
                <div className="rounded-3xl border border-s-subtle bg-b-surface2 p-6 md:flex md:items-center md:justify-between">
                    <div>
                        <p className="text-sm text-t-secondary">Tradexa 2.0</p>
                        <p className="mt-1 text-lg font-semibold">Trade mieux, avec mÃ©thode.</p>
                    </div>
