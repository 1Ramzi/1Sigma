...
const CampaignEarning = ({}) => {
    const { t } = useLanguage();
    const last7DaysLabel = t.last7Days || "7 derniers jours";
    const durationSuffix =
        last7DaysLabel.split(" ").slice(1).join(" ") || last7DaysLabel;

    const durations: SelectOption[] = [
        { id: 1, name: last7DaysLabel },
        { id: 2, name: `14 ${durationSuffix}` },
        { id: 3, name: `28 ${durationSuffix}` },
    ];
